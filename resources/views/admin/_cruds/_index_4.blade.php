                                    ...
                                    <div class="card card-custom gutter-b card-stretch bg-light">
                                                ...
                                                <div class="card-label">{{ $row->title }}
                                                    <div class="font-size-sm text-muted mt-2">
                                                        ...
                                                        @if ($row->is_youtube == 1)
                                                            ...
                                                            <span
                                                                class="label label-light-success label-inline">Youtube</span>
                                                        @else
                                        ...
                                        <div class="card-body d-flex flex-column" style="position: relative;">
                                            ...
                                            <div class="m-auto">
                                                ...
                                                <a onclick="Delete('{{ route('admin.videos.destroy', $row->id) }}')"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="modal-text text-center mb-10">
                                                ...
                                                <h4 class="text-dark font-weight-bolder d-block mb-5"> You are about to
                                                    delete an item!</h4>
