                            ...
                            <div class="pt-5">
                                ...
                                <ul class="nav navi navi-accent navi-hover navi-bold" role="tablist">
                                    <li class="nav-item navi-item">
                                        <a class="nav-link navi-link active" data-toggle="tab"
                ...
                <div class="card-body px-0">
                    <div class="tab-content pt-5">
                        ...
                        <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                            <form class="form" action="{{ route('admin.admins.update', user()->id) }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6 text-center">
                                        <div class="image-input image-input-outline image-input-circle" id="user_avatar">
                                            <div class="image-input-wrapper"
                                                style="background-image: url('{{ Storage::disk(env('APP_DISK'))->url(user()->avatar) }}')">
                                            </div>
                                            <label
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text"
                                            value="{{ user()->getRoleNames() }}" disabled />
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
