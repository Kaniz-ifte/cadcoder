                    ...
                    <div class="d-flex justify-content-between flex-column pt-4 h-100">
                        ...
                        <div class="pb-5">
                            ...
                            <div class="d-flex flex-column flex-center">
                                ...
                                <!--end::Symbol-->
                                <!--begin::Username-->
                                <div class="card-title font-weight-bolder text-dark-75  font-size-h4 m-0 pt-7 pb-1">
                                    {{ user()->name }}</div>
                                <!--end::Username-->
                                <!--begin::Info-->
                                ...
                                <ul class="nav navi navi-accent navi-hover navi-bold" role="tablist">
                                    ...
                                    @foreach ($data as $rows)
                                        ...
                                        <li class="nav-item navi-item">
                                            <a class="nav-link navi-link {{ $serial == 1 ? 'active' : '' }}"
                                                data-toggle="tab" href="#{{ $rows[0]->root }}">
                                                ...
                                                <span class="nav-text font-weight-bold">{{ $rows[0]->root }}</span>
                                            </a>
                                        </li>
                        ...
                        <div class="d-flex flex-center mt-5">
                            <button class="btn btn-danger font-weight-bolder font-size-sm py-3 px-14">Reset All</button>
                        </div>
                        <!--end::Footer-->
                    </div>
                    <!--end::Wrapper-->
                ...
                <div class="card-body px-0">
                    <div class="tab-content pt-5">
                        ...
                        @foreach ($data as $rows)
                            ...
                            <!--begin::Tab Content-->
                            <div class="tab-pane {{ $serial == 1 ? 'active' : '' }}" id="{{ $rows[0]->root }}"
                                role="tabpanel">
                                @foreach ($rows as $row)
