...
<div id="kt_header_mobile" class="header-mobile {{ Metronic::printClasses('header-mobile', false) }}" {{ Metronic::printAttrs('header-mobile') }}>
    ...
    <div class="mobile-toolbar">
        ...
        <button class="mobile-toggle mobile-toggle-left ml-3 btn p-0 burger-icon burger-icon-left" id="kt_aside_mobile_toggle"><span></span></button>
        @endif

        @if (config('layout.header.menu.self.display'))
        <button class="mobile-toggle ml-3 btn p-0 burger-icon" id="kt_header_mobile_toggle"><span></span></button>
        @endif

        <button class="topbar-toggle btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
