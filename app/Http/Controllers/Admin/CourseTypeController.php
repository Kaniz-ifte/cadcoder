<?php
        ...
        class CourseTypeController extends Controller
        {
            ...
            {
                 $this->middleware('permission:coursetype-view|coursetype-create|coursetype-update|coursetype-delete', ['only' => ['index']]);
                 $this->middleware('permission:coursetype-create', ['only' => ['create','store']]);
                 $this->middleware('permission:coursetype-update', ['only' => ['edit','update']]);
                 $this->middleware('permission:coursetype-delete', ['only' => ['destroy']]);
                 $this->model='App\CourseType';
                 $this->key_word='CourseType';
                 $this->key_word_plural='CourseTypes';
                 $this->route_index='admin.coursetypes.index';
                 $this->route_create='admin.coursetypes.create';
                 $this->route_edit='admin.coursetypes.edit';
                 $this->route_update='admin.coursetypes.update';
                 $this->route_destroy='admin.coursetypes.destroy';
                 $this->route_store='admin.coursetypes.store';
                 ...
                 $this->update_except_columns=['_token','banner','old_banner'];
            ...
            {
                $data = app($this->model)->orderBy('id','DESC');$page_title = $this->key_word;
$info=new stdClass();
