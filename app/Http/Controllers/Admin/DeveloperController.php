...
class DeveloperController extends Controller
{
    ...
    public function columns(Request $request)
    {
        ...
        $info->table_columns = BaseColumn::where('is_active', 1)->orderBy('order', 'ASC')->get();
        // $info->table_columns = [
        //     [
        //         "title" => 'Serial',
        //         "index" => 'serial',
    ...
    public function inputs()
    {
        ...
        $info = new stdClass();
        $info->form_inputs = BaseInput::where('is_active', 1)->orderBy('order', 'ASC')->get();
        ...
        // ];
        return view('admin.developer.inputs.index', compact('page_title', 'info'));
    }
    ...
    {
        return view('admin.developer.payment-gateways');
    }
}
