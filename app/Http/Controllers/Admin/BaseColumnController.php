...
class BaseColumnController extends Controller
{
    /**
    ...
    {
        $this->middleware('permission:base-column-view|base-column-create|base-column-update|base-column-delete', ['only' => ['index']]);
        $this->middleware('permission:base-column-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:base-column-update', ['only' => ['edit', 'update']]);
        $this->middleware('permission:base-column-delete', ['only' => ['destroy']]);
        $this->model = 'App\BaseColumn';
        $this->key_word = 'Base Column';
        $this->key_word_plural = 'Base Columns';
        $this->route_index = 'admin.base-columns.index';
        $this->route_create = 'admin.base-columns.create';
        $this->route_edit = 'admin.base-columns.edit';
        $this->route_update = 'admin.base-columns.update';
        $this->route_destroy = 'admin.base-columns.destroy';
        $this->route_store = 'admin.base-columns.store';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route("admin.developer.columns")
    ...
    public function getParams(BaseColumn $base_column)
    {
        return response()->json($base_column->params);
    }
}
