...
class TestOneController extends Controller
{
     ...
     {
          $this->middleware('permission:testone-view|testone-create|testone-update|testone-delete', ['only' => ['index']]);
          $this->middleware('permission:testone-create', ['only' => ['create', 'store']]);
          $this->middleware('permission:testone-update', ['only' => ['edit', 'update']]);
          $this->middleware('permission:testone-delete', ['only' => ['destroy']]);
          $this->model = 'App\TestOne';
          $this->key_word = 'TestOne';
          $this->key_word_plural = 'TestOnes';
          $this->route_index = 'admin.testones.index';
          $this->route_create = 'admin.testones.create';
          $this->route_edit = 'admin.testones.edit';
          $this->route_update = 'admin.testones.update';
          $this->route_destroy = 'admin.testones.destroy';
          $this->route_store = 'admin.testones.store';
