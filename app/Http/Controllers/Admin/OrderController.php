...
class OrderController extends Controller
{
     ...
     {
          $this->middleware('permission:order-view|order-create|order-update|order-delete', ['only' => ['index']]);
          $this->middleware('permission:order-create', ['only' => ['create', 'store']]);
          $this->middleware('permission:order-update', ['only' => ['edit', 'update']]);
          $this->middleware('permission:order-delete', ['only' => ['destroy']]);
          $this->model = 'App\Order';
          $this->key_word = 'Order';
          $this->key_word_plural = 'Orders';
          $this->route_index = 'admin.orders.index';
          $this->route_create = 'admin.orders.create';
          $this->route_edit = 'admin.orders.edit';
          $this->route_update = 'admin.orders.update';
          $this->route_destroy = 'admin.orders.destroy';
          $this->route_store = 'admin.orders.store';
