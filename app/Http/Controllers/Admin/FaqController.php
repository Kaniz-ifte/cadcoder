...
class faqController extends Controller
{
     ...
     {
          $this->middleware('permission:faq-view|faq-create|faq-update|faq-delete', ['only' => ['index']]);
          $this->middleware('permission:faq-create', ['only' => ['create', 'store']]);
          $this->middleware('permission:faq-update', ['only' => ['edit', 'update']]);
          $this->middleware('permission:faq-delete', ['only' => ['destroy']]);
          $this->model = 'App\Faq';
          $this->key_word = 'Faq';
          $this->key_word_plural = 'Faqs';
          $this->route_index = 'admin.faqs.index';
          $this->route_create = 'admin.faqs.create';
          $this->route_edit = 'admin.faqs.edit';
          $this->route_update = 'admin.faqs.update';
          $this->route_destroy = 'admin.faqs.destroy';
          $this->route_store = 'admin.faqs.store';
