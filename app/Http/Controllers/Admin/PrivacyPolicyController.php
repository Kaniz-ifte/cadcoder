...
class PrivacyPolicyController extends Controller
{
     ...
     {
          $this->middleware('permission:privacy-policy-view|privacy-policy-create|privacy-policy-update|privacy-policy-delete', ['only' => ['index']]);
          $this->middleware('permission:privacy-policy-create', ['only' => ['create', 'store']]);
          $this->middleware('permission:privacy-policy-update', ['only' => ['edit', 'update']]);
          $this->middleware('permission:privacy-policy-delete', ['only' => ['destroy']]);
          $this->model = 'App\PrivacyPolicy';
          $this->key_word = 'Privacy Policy';
          $this->key_word_plural = 'Privacy Policy';
          $this->route_index = 'admin.privacy-policy.index';
          $this->route_create = 'admin.privacy-policy.create';
          $this->route_edit = 'admin.privacy-policy.edit';
          $this->route_update = 'admin.privacy-policy.update';
          $this->route_destroy = 'admin.privacy-policy.destroy';
          $this->route_store = 'admin.privacy-policy.store';
