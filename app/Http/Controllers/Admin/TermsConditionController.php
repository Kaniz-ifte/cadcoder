...
class TermsConditionController extends Controller
{
     ...
     {
          $this->middleware('permission:terms-conditions-view|terms-conditions-create|terms-conditions-update|terms-conditions-delete', ['only' => ['index']]);
          $this->middleware('permission:terms-conditions-create', ['only' => ['create', 'store']]);
          $this->middleware('permission:terms-conditions-update', ['only' => ['edit', 'update']]);
          $this->middleware('permission:terms-conditions-delete', ['only' => ['destroy']]);
          $this->model = 'App\TermsCondition';
          $this->key_word = 'Terms Conditions';
          $this->key_word_plural = 'Terms Conditions';
          $this->route_index = 'admin.terms-conditions.index';
          $this->route_create = 'admin.terms-conditions.create';
          $this->route_edit = 'admin.terms-conditions.edit';
          $this->route_update = 'admin.terms-conditions.update';
          $this->route_destroy = 'admin.terms-conditions.destroy';
          $this->route_store = 'admin.terms-conditions.store';
