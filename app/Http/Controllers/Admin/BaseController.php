...
class BaseController extends Controller
{
     ...
     {
          $this->middleware('permission:base-view|base-create|base-update|base-delete', ['only' => ['index']]);
          $this->middleware('permission:base-create', ['only' => ['create', 'store']]);
          $this->middleware('permission:base-update', ['only' => ['edit', 'update']]);
          $this->middleware('permission:base-delete', ['only' => ['destroy']]);
          $this->model = 'App\Base';
          $this->key_word = 'Base';
          $this->key_word_plural = 'Bases';
          $this->route_index = 'admin.bases.index';
          $this->route_create = 'admin.bases.create';
          $this->route_edit = 'admin.bases.edit';
          $this->route_update = 'admin.bases.update';
          $this->route_destroy = 'admin.bases.destroy';
          $this->route_store = 'admin.bases.store';
          ...
          $this->form_inputs = [
               ...
               [
                    "title" => 'Banner:',
                    "id" => 'image_1',
                    "sample_image" => 'media/sample/base.jpg',
